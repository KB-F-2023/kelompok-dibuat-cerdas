...
class Puzzle:
    ...
    def solve(self):
        ...
        frontier = QueueFrontier()  # create the frontier as a queue
        frontier.add(start)

        self.explored = []  # initialize the explored set to be empty
        ...
        while True:
            ...
            for action, state in self.neighbors(node.state):
                # only consider states that haven't been explored and aren't in the frontier
